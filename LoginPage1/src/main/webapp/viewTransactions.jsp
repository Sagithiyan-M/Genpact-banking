...
<body>
    ...
    %>
    <a href="customerDashboard.jsp" class="back-link"><i class="fa fa-arrow-left"></i>Back to Dashboard</a>
    <a href="PrintTransactionServlet" class="download-link"><i class="fa fa-file-pdf"></i>Download Transactions as PDF</a>
</body>
</html>